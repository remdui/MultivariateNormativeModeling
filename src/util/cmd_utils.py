...
def parse_args():
    ...
    parser.add_argument('--checkpoint_interval', type=int, help="Interval for saving checkpoints")
    parser.add_argument('--log_dir', type=str, help="Directory to save logs and outputs")
    parser.add_argument('--output_dir', type=str, help="Directory to store inference results")
