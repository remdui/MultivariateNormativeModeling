...
from preprocessing.abstract_dataloader import AbstractDataloader
from preprocessing.freesurfer_data.freesurfer_dataset import FreeSurferDataset


class FreeSurferDataloader(AbstractDataloader):
    """Dataloader for the FreeSurfer dataset."""

    def __init__(self) -> None:
        """Initialize the FreeSurferDataloader using properties."""
        self.logger = LogManager.get_logger(__name__)
        self.properties = Properties.get_instance()

        # Access configuration directly from properties
        self.data_dir = self.properties.system.data_dir
        self.processed_data_file = self.properties.dataset.processed_data_file
        self.csv_path = Path(self.data_dir) / "processed" / self.processed_data_file
    ...
    def _setup(self) -> None:
        ...
        self.logger.info("Initializing FreeSurferDataset...")
        try:
            self.dataset = FreeSurferDataset(
