"""Input feature covariate embedding strategy."""
...
class InputFeatureEmbeddingStrategy(BaseEmbeddingStrategy):
    """Input feature covariate embedding strategy."""
    ...
    def forward(self, x: Tensor, covariates: Tensor | None) -> dict:
        if covariates is None:
            raise UnsupportedCovariateEmbeddingTechniqueError(
                "Covariates must be provided for input_feature embedding."
            )
